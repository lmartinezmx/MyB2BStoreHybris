 ...
 */
package mx.myb2bhybris.test.setup;
...
import mx.myb2bhybris.test.constants.Myb2bhybrisTestConstants;
import mx.myb2bhybris.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Myb2bhybrisTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/myb2bhybristest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/myb2bhybristest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/myb2bhybristest/import/cstickets.impex");
			...
			importImpexFile(context, "/myb2bhybristest/import/csquotes.impex");
		}
	}
}
